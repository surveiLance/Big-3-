...
export default function Home() {
  return (
    <main className="min-h-screen overflow-hidden bg-[#030404] text-white">
      <div className="relative min-h-screen">
        ...
        <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-[1536px] flex-col px-4 py-5 sm:px-9 sm:py-6">
          <header className="border-b border-white/12 pb-4 sm:pb-5">
            ...
            <nav className="hidden flex-1 items-center justify-center gap-12 text-sm font-bold uppercase tracking-wide text-white/88 lg:flex xl:gap-16">
              {navItems.map((item) => (
                <Link
                  ...
                  className={
                    item.label === "Home"
                      ? "border-b-2 border-[#d9ae64] pb-5 text-[#e4bd73]"
                      : "pb-5 transition hover:text-[#e4bd73]"
                  }
                >
                  {item.label}
                </Link>
            ...
            <nav className="-mx-4 mt-4 flex gap-2 overflow-x-auto px-4 pb-1 text-[11px] font-black uppercase tracking-wide text-white/75 lg:hidden">
              {navItems.map((item) => (
                <Link
                  ...
                  className={
                    item.label === "Home"
                      ? "shrink-0 rounded border border-[#d9ae64]/50 bg-[#d9ae64]/12 px-3 py-2 text-[#e4bd73]"
                      : "shrink-0 rounded border border-white/12 bg-white/[0.04] px-3 py-2"
                  }
                >
                  {item.label}
                </Link>
